...
// VolumesnapshotV1Client is used to interact with features provided by the volumesnapshot group.
type VolumesnapshotV1Client struct {
	restClient rest.Interface
}

func (c *VolumesnapshotV1Client) SnapshotClasses() SnapshotClassInterface {
